            ...
            <div className='maindiv'>
                ...
                {/* <Link to="#"  style={{textDecoration:"none"}}> */}
                    <ul>
                        ...
                        <li><Link to='#' style={{textDecoration:"none"}} ><p>View All Services</p></Link></li>
                        <li><Link to='#' style={{textDecoration:"none"}} ><p>Our Artistry Experts</p></Link></li>
                        <li><Link to='#' style={{textDecoration:"none"}} ><p>Camera-Ready Filters</p></Link></li>
                        <li><Link to='#' style={{textDecoration:"none"}} ><p>Live Stream Videos</p></Link></li>
                    </ul>
                {/* </Link> */}
            </div>
        </div>
